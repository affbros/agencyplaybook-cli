...
Keyword reads: list ad-group keyword criteria.
...
| Subcommand | Summary |
|---|---|
| [`list`](#apb-gads-keyword-list) |  |

---

<a id="apb-gads-keyword-list"></a>
### `apb-gads keyword list`

**Usage**

```
Usage: apb-gads keyword list [OPTIONS]
```
