...
| Subcommand | Summary |
|---|---|
| [`list`](#apb-gads-negative-keyword-list) |  |

---

<a id="apb-gads-negative-keyword-list"></a>
### `apb-gads negative-keyword list`

**Usage**

```
Usage: apb-gads negative-keyword list [OPTIONS]
```
