...
Ad-group reads: list ad groups under a campaign.
...
| Subcommand | Summary |
|---|---|
| [`list`](#apb-gads-ad-group-list) |  |

---

<a id="apb-gads-ad-group-list"></a>
### `apb-gads ad-group list`

**Usage**

```
Usage: apb-gads ad-group list [OPTIONS]
```
