...
Run ad-hoc Google Ads Query Language (GAQL) against the searchStream endpoint.
...
| Subcommand | Summary |
|---|---|
| [`query`](#apb-gads-gaql-query) |  |

---

<a id="apb-gads-gaql-query"></a>
### `apb-gads gaql query`

**Usage**

```
Usage: apb-gads gaql query [OPTIONS] --query <QUERY>
```
