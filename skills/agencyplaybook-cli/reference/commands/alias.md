...
```bash
apb alias list --allow-domain <HOST> --guardrail-reason <TEXT>
```
...
```bash
apb alias remove --execute --allow-domain <HOST> --guardrail-reason <TEXT>
```
...
```bash
apb alias set --execute --allow-domain <HOST> --guardrail-reason <TEXT>
```
