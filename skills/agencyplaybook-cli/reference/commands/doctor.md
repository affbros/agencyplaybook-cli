...
4 commands. Auto-generated from the apb binary on 2026-09-11.
...
```bash
apb doctor api-compat --plan <PATH> --fonts <MODE>
```
...
```bash
apb doctor check --plan <PATH> --fonts <MODE>
```
...
```bash
apb doctor quota --plan <PATH> --fonts <MODE>
```
...
```bash
apb doctor validate-only-matrix --plan <PATH> --fonts <MODE>
```
