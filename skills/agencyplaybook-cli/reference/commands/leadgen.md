...
6 commands. Auto-generated from the apb binary on 2026-09-11.
...
**Scope:** `write:leadgen` · **Min tier:** professional · **Write op** (requires `--execute`)
...
```bash
apb leadgen get --id <ID> --plan <PATH>
```
