...
# (LAL seeds, custom-audience refresh) judge signal volume, not ad performance —
# forcing them through the conversions/spend/impressions gate above would always
# fail (audiences carry no conversions). Gates against MIN_AUDIENCE_SIZE.
